...
bidscoiner $pre_bids_folder $after_bids_folder

# bidcoiner는 bidsmapper가 만들어준 bidsmap을 사용해서 bids format을 만들어준다. bidsmap은 이전에 bidsmapper.sh에서 after_bids_folder에서 만들어놓은 bidsmap.yaml을 사용한다.
