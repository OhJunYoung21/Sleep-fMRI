...
class Configuration:
    ...
    def __init__(self, config_map: Optional[dict] = None,
        ...
        """
        from Comparison_features.CPAC.pipeline.schema import schema
        from Comparison_features.CPAC.utils.utils import lookup_nested_value, update_nested_dict
...
def preconfig_yaml(preconfig_name='default', load=False):
    ...
    """
    from Comparison_features.CPAC.pipeline import ALL_PIPELINE_CONFIGS, AVAILABLE_PIPELINE_CONFIGS
